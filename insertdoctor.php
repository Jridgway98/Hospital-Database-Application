...
require_once("connection.php");
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$document = ['_id' => new MongoDB\BSON\ObjectID, 'lastName' => $lastname, 'firstName' => $firstname,'SSN' => $ssn, 'DOB' => $dob, 'phoneNumber' => $phonenumber, 'departmentID' => new MongoDB\BSON\ObjectId($department), 'address' => $address];

		$bulk->insert($document);
		$m->executeBulkWrite('hospital.Doctors', $bulk);
...
<head>
	...
	<title>Insert a New Doctor</title>
</head>
